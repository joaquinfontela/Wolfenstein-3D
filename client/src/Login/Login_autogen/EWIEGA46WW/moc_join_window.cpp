...
struct qt_meta_stringdata_join_window_t {
    QByteArrayData data[3];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_join_window_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_join_window_t qt_meta_stringdata_join_window = {
    {
QT_MOC_LITERAL(0, 0, 11), // "join_window"
QT_MOC_LITERAL(1, 12, 22), // "on_join_button_clicked"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "join_window\0on_join_button_clicked\0"
};
...
void *join_window::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_join_window.stringdata0))
        return static_cast<void*>(this);
    return QDialog::qt_metacast(_clname);
}

int join_window::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
