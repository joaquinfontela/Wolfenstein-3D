...
public:
    ...
    void setupUi(QMainWindow *Editor)
    {
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("iconos/copy_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCopy->setIcon(icon4);
        actionPaste = new QAction(Editor);
        actionPaste->setObjectName(QString::fromUtf8("actionPaste"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("iconos/paste_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPaste->setIcon(icon5);
        actionUndo = new QAction(Editor);
        actionUndo->setObjectName(QString::fromUtf8("actionUndo"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("iconos/undo_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionUndo->setIcon(icon6);
        actionRedo = new QAction(Editor);
        actionRedo->setObjectName(QString::fromUtf8("actionRedo"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("iconos/redo_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRedo->setIcon(icon7);
        actionEXIT = new QAction(Editor);
        actionEXIT->setObjectName(QString::fromUtf8("actionEXIT"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8("iconos/quit_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8("iconos/save_and_quit_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8("iconos/zoom_in_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionZoom_in->setIcon(icon10);
        actionZoom_out = new QAction(Editor);
        actionZoom_out->setObjectName(QString::fromUtf8("actionZoom_out"));
        QIcon icon11;
        icon11.addFile(QString::fromUtf8("iconos/zoom_out_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
