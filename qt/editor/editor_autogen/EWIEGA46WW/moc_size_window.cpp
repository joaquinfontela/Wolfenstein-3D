...
void size_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<size_window *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject size_window::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_size_window.data,
    qt_meta_data_size_window,
    qt_static_metacall,
    nullptr,
    nullptr
} };
