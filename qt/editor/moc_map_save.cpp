...
#define QT_MOC_LITERAL(idx, ofs, len)                                      \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                 \
      len, qptrdiff(offsetof(qt_meta_stringdata_map_save_t, stringdata0) + \
...
void map_save::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id,
                                  void **_a) {
  if (_c == QMetaObject::InvokeMetaMethod) {
    auto *_t = static_cast<map_save *>(_o);
    Q_UNUSED(_t)
    switch (_id) {
      case 0:
        _t->set_map();
...
QT_INIT_METAOBJECT const QMetaObject map_save::staticMetaObject = {
